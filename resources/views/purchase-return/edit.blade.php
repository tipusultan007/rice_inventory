        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('purchase_returns.index') }}" class="btn btn-primary d-none d-sm-inline-block">
            ...
            @endif
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="form" action="{{ route('purchase_returns.update', $purchaseReturn->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <table class="table table-sm products table-borderless">
                                            ...
                                            @foreach($purchaseReturn->purchaseReturnDetail as $index => $detail)
                                                <tr class="product-entry">
                                                    <td>
                                                        <select name="products[{{ $index }}][product_id]" class="form-select  products-select2" required data-placeholder="সিলেক্ট প্রোডাক্ট">
                                                            <option data-price-rate="{{ $detail->price_rate }}" value="{{ $detail->product->id }}">
                                                                {{ $detail->product->name }}
                                                            </option>
                                                        </select>
                                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <th class="subtotal border-0 py-2">
                                                    <input type="number" name="subtotal" class="form-control" value="{{ $purchaseReturn->purchaseReturnDetail->sum('amount') }}" readonly>
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="total border-0 py-2">
                                                    <input type="number" name="total" class="form-control" value="{{ $purchaseReturn->total }}" readonly>
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="total border-0 py-2">
                                                    <input type="text" name="note" class="form-control" value="{{ $purchaseReturn->note }}">
                                                    @error('note')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </th>
