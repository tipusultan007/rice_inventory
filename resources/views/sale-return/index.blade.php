        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('sale_returns.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('sale_returns.show',$saleReturn->id) }}">
                                                            View
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('sale_returns.edit',$saleReturn->id) }}">
                                                            Edit
                                                        </a>
                                                        <form
                                                            action="{{ route('sale_returns.destroy',$saleReturn->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
