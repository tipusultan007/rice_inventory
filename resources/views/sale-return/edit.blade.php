            ...
            @endif
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="form" action="{{ route('sale_returns.update',$saleReturn->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="number" name="invoice_no" class="form-control"
                                                   value="{{ $saleReturn->sale->invoice_no }}" required>
                                            @error('invoice_no')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select name="customer_id" class="form-select select2" required>
                                                <option
                                                    value="{{ $saleReturn->customer_id }}">{{ $saleReturn->customer->name }}</option>
                                            </select>
                                            @error('customer_id')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <tr>
                                                ...
                                                <th class="subtotal border-0 py-2">
                                                    <input type="number" name="subtotal" class="form-control"
                                                           value="{{ $saleReturn->saleReturnDetail->sum('amount') }}" readonly>
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="total border-0 py-2">
                                                    <input type="number" name="total" class="form-control"
                                                           value="{{ $saleReturn->total }}" readonly>
                                                </th>
                                                ...
                                                <td class="total border-0 py-2">
                                                    <select name="account_id" id="account_id"
                                                        ...
                                                        @forelse($methods as $method)
                                                            <option
                                                                value="{{ $method->id }}" {{ $payment?$payment->account_id == $method->id?'selected':'':'' }}>{{ $method->name }}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                                    @error('account_id')
