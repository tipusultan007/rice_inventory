                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <form action="{{ route('purchase.export') }}" method="GET">
                                                <div class="row">
                                                    <div class="col-md-4">
                ...
                <div class="col-12">
                    <div class="card">
                        <table class="table table-vcenter table-sm table-bordered datatable">
                            <thead>
                            <tr>
                                <th class="fw-bolder fs-3">ক্রয়ের তারিখ</th>
                                <th class="fw-bolder fs-3">চালান নং</th>
                                <th class="fw-bolder fs-3">সাপ্লাইয়ার</th>
                                <th class="fw-bolder fs-3">পরিমাণ</th>
                                <th class="fw-bolder fs-3">সর্বমোট</th>
                                <th class="fw-bolder fs-3">পরিশোধ</th>
                                <th class="w-1"></th>
                            </tr>
                            </thead>
